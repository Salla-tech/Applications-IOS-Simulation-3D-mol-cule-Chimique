...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil 
{
	...
	{
		self.title = NSLocalizedStringFromTable(@"Personnaliser la location", @"Localized", @"");
...
//	UIView *mainView = [[UIView alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
	...
	descriptionLabel.text = NSLocalizedStringFromTable(@"Tapez ou collez dans l'emplacement de la molécule personnalisée et appuyez sur Go pour commencer le téléchargement.", @"Localized", @"");
	...
	urlInput.placeholder = NSLocalizedStringFromTable(@"Localisation de la molécules", @"Localized", nil);
...
- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error
{
	...
	UIAlertView *alert = [[UIAlertView alloc] initWithTitle:NSLocalizedStringFromTable(@"Erreur dans l'emplacement personnalisé de chargement", @"Localized", nil) message:NSLocalizedStringFromTable(@"L'adresse n'a pas pu être atteint", @"Localized", nil)
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField
{
	...
	{
		UIAlertView *alert = [[UIAlertView alloc] initWithTitle:NSLocalizedStringFromTable(@"Erreur dans l'emplacement personnalisé de chargement", @"Localized", nil) message:NSLocalizedStringFromTable(@"L'adresse ne contient pas un fichier d'un type de molécule supporté.", @"Localized", nil)
													   delegate:self cancelButtonTitle:NSLocalizedStringFromTable(@"OK", @"Localized", nil) otherButtonTitles: nil, nil];
		[alert show];
	}
